...
AgendaProximaIteracao(){
    ...
    cmd="/home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/GNL/encad_dc_nw_mensal_3_270410.sh $1"
...
then
   ...
   /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/FT/decomp.sh $v;
   ec=$? 
fi
#if [ $ec == 0 -o $ec == 7 ]
