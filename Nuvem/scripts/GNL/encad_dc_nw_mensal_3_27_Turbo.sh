...
agendaDCGNL(){
    ...
    usr="encad"
    fn="/home/compass/queuectl/queue/encadeado_DC${ano}${mes}_${dt}"
    cmd="/home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/GNL/DADGNL_decomp301Viab_Turbo.sh"
...
if [ -d $ano$mes ]; then
    ...
    if [ ! -f "cortes.dat" ]; then
        ...
        echo /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newave27_Turbo.sh 1
        /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newave27_Turbo.sh 1
