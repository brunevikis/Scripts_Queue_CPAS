...
cp /home/producao/PrevisaoPLD/shared/gevazp/gevazp.lic ./GEVAZP.LIC

if [ -f modif.dat ] 
then
    mv modif.dat MODIF.DAT
else
    cp /home/producao/PrevisaoPLD/shared/gevazp/MODIF.DAT ./MODIF.DAT
fi

if [ ! -f regras.dat  ]
then
    cp /home/producao/PrevisaoPLD/shared/gevazp/REGRAS.DAT ./regras.dat
fi

if [ ! -f postos.dat  ]
then
    cp /home/producao/PrevisaoPLD/shared/gevazp/POSTOS.DAT ./postos.dat
fi

if [ ! -f gevazp.dat  ]
then
    cp /home/producao/PrevisaoPLD/shared/gevazp/GEVAZP.DAT ./gevazp.dat
fi

if [ ! -f arquivos.dat  ]
then
    cp /home/producao/PrevisaoPLD/shared/gevazp/ARQUIVOS.DAT ./arquivos.dat
fi

echo "-----------[ Executando ConverteNomesArquivosDecomp${ver} -----------";
/opt/aplicacoes/decomp/bin/convertenomesdecomp_27;
echo -e "\n";
...
( /home/producao/PrevisaoPLD/shared/gevazp/gevazp_L; rm caso.dat; mv caso.dat.tmp caso.dat; );
