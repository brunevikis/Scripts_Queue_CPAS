...
agendaDCGNL(){
    ...
    usr="encad"
    fn="/home/compass/queuectl/queue/encadeado_DC${ano}${mes}_${dt}"
    cmd="/home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/GNL/DADGNL_decomp301Viab_meta.sh"
...
if [ -d $ano$mes ]; then
    ...
    if [ ! -f "cortes.dat" ]; then
        ...
        echo /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newave270001.sh 1
        /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newave270001.sh 1
    ...
    if [ -f "cortes.dat" ]; then
        ...
        echo /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/nwlistop270001.sh
        /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/nwlistop270001.sh
        ...
        echo /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newdesp270001.sh
        /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newdesp270001.sh
