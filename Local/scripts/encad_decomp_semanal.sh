...
comando="/home/producao/PrevisaoPLD/cpas_ctl_common/scripts/decomp29Viab.sh"
...
then
    ...
    then
        ...
        do            
            echo /home/producao/PrevisaoPLD/cpas_ctl_common/scripts/buscaEarm_dc_dc.sh "$dir" "$nextF"            
            /home/producao/PrevisaoPLD/cpas_ctl_common/scripts/buscaEarm_dc_dc.sh "$dir" "$nextF"            
            ...
            then
                 ...
                 ord=$(( 30 ))
                 usr="encad"
                 fn="/home/producao/PrevisaoPLD/cpas_ctl_common/queue/encadeado_decomp_semanal_${dt}"
                 cmd="$0"
