...
AgendaProximaIteracao(){
    ...
    cmd="/home/producao/PrevisaoPLD/enercore_ctl_common/scripts/FT/GNL/encad_dc_nw_mensal_3_281103_earDC_Tuctuc_sobr.sh $1"
...
if($4=="   NE"||$1+0==275||$1+0==169){print $0}
else{printf "%s%s%6.2f%s%s\n",$1,$2,v[$1+0],$4,$5}}}
