...
AgendaProximaIteracao(){
    ...
    cmd="/home/producao/PrevisaoPLD/enercore_ctl_common/scripts/FT/GNL/encad_dc_nw_mensal_3_281501_earDC_regrasANA_cortesPOS.sh $1"
...
' temp "../../$anoN$mesN/confhd.bkp" > "$confhd"
    ...
    mv "${modif}" "${modif}.bkp"
    awk -v "n=$n"  -v "y=$anoN" -v "m=$mesN" -f "/home/producao/PrevisaoPLD/enercore_ctl_common/awk/modif_hibrido.awk" temp "${modif}.bkp" >> "${modif}" || exit 111
