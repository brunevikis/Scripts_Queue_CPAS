...
echo "/home/compass/sacompass/previsaopld/shared/install/newave/newave_${ver}/Executaveis/" >> caso.dat


echo -e "\n"
echo "-----------[ Convertendo nome dos arquivos ] --------------"
echo /home/compass/sacompass/previsaopld/shared/install/newave/newave_${ver}/Executaveis/ConverteNomesArquivos
/home/compass/sacompass/previsaopld/shared/install/newave/newave_${ver}/Executaveis/ConverteNomesArquivos;
...
if [ $tipoExec -eq 1 ]; then
	...
	echo "-----------[ Limpando sujeira ] --------------"
		...
		echo /home/compass/sacompass/previsaopld/shared/install/newave/newave_${ver}/Executaveis/newave${ver}_L
		/home/compass/sacompass/previsaopld/shared/install/newave/newave_${ver}/Executaveis/newave${ver}_L;
		...
		if [ $tipoSim -eq 1 -o $tipoSim -eq 2 ]; then
			...
			#work_dir=/mnt/resource/newave/$(date +%Y%m%d%H%M%s%N)/
...
for i in $( ls -p | grep "/$" -v ); do
    ...
    if [ ! "$i" == "$AUXLOWER" ]; then
        ...
        if [ -f $AUXLOWER ]; then
            ...
            echo "/home/compass/mpich3/bin/mpiexec -n ${cores} /home/compass/sacompass/previsaopld/shared/install/newave/newave_${ver}/Executaveis/newave${ver}_L"
            /home/compass/mpich3/bin/mpiexec -n ${cores} /home/compass/sacompass/previsaopld/shared/install/newave/newave_${ver}/Executaveis/newave${ver}_L;
