...
agendaDCGNL(){
    ...
    usr="encad"
    fn="/home/producao/PrevisaoPLD/enercore_ctl_common/queue/encadeado_DC${ano}${mes}_${dt}"
    cmd="/home/producao/PrevisaoPLD/enercore_ctl_common/scripts/GNL/DADGNL_decomp31Viab_metaREEuhNao.sh"
...
if [ -d $ano$mes ]; then
    ...
    if [ ! -f "cortes.dat" ]; then
        ...
        /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/newave_ssd.sh 28 1
