...
echo "/home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/Altera_DADGNL.sh";
/bin/bash /home/producao/PrevisaoPLD/Teste/teste2.sh



origin_dir=$(pwd)

anomes=$(echo "$origin_dir" | cut -d"/" -f8 )
