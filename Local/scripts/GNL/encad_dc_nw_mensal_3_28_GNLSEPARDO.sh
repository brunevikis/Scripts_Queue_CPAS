...
agendaDC(){
    ...
    cmd="/home/producao/PrevisaoPLD/enercore_ctl_common/scripts/GNL/decomp31ViabSeparado.sh"
...
agendaDCGNL(){
    ...
    usr="encad"
    fn="/home/producao/PrevisaoPLD/enercore_ctl_common/queue/encadeado_DC${ano}${mes}_${dt}"
    cmd="/home/producao/PrevisaoPLD/enercore_ctl_common/scripts/GNL/DADGNL_decomp31ViabSeparado.sh"
