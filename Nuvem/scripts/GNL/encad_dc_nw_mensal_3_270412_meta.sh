...
if [ -f /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/functions.sh ]; then source /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/functions.sh; 
...
agendaDC(){
    ...
    cmd="/home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/FT/decomp30.14Viab.sh"
...
agendaDCGNL(){
    ...
    usr="encad"
    fn="/home/compass/queuectl/queue/encadeado_DC${ano}${mes}_${dt}"
    cmd="/home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/GNL/DADGNL_decomp3014Viab_meta.sh"
        ...
        for ree in ${rees[@]}; do
            ...
            if [[ ${reeSis[$ree]} -eq $sis ]]; then      
                ...
                if [[ $sis -eq 2 ]]; then
                    ...
                    earmNp[$ree]=$( echo "scale=3 ; ( ( $volumePO - 100 ) * ( ( $volumeFinalRee - 100 ) / ( $volumeFinalMercado - 100 ) ) ) + 100" | bc -l )
                fi
            fi
        done
    done
...
if [ -d $ano$mes ]; then
    ...
    if [ ! -f "cortes.dat" ]; then
        ...
        echo /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newave270410.sh 1
        /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newave270410.sh 1
    ...
    if [ -f "cortes.dat" ]; then
        ...
        echo /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/nwlistop270410.sh
        /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/nwlistop270410.sh
        ...
        echo /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newdesp270410.sh
        /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newdesp270410.sh
        ...
        #( /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/roda_abertura.sh )
       ...
       if [[ "$mesN" == "13" ]]; then
        ...
        if [ -d $anoN$mesN ]; then    
          ...
          echo "/usr/bin/dotnet /home/compass/sacompass/previsaopld/shared/price_tools/inviab/bin/Debug/netcoreapp2.0/TrataInviab.dll metaencad $ano$mes $anoN$mesN"
          /usr/bin/dotnet /home/compass/sacompass/previsaopld/shared/price_tools/inviab/bin/Debug/netcoreapp2.0/TrataInviab.dll "metaencad" "$ano$mes" "$anoN$mesN"
