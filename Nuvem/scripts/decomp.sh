...
echo "/home/compass/sacompass/previsaopld/shared/install/decomp/${ver}/Executaveis/" >> $arqName;

echo -e "\n";

echo "-----------[ Executando ConverteNomesArquivosDecomp${ver} -----------";
/home/compass/sacompass/previsaopld/shared/install/decomp/${ver}/Executaveis/convertenomesdecomp_${ver};
echo -e "\n";
...
if [ ! "$gevazp" == "nao" ]; then
    ...
    if [ ! -f vazoes.$arqName ]; then
        ...
        /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/gevazp.sh   
...
echo "/home/compass/sacompass/previsaopld/shared/install/decomp/${ver}/Executaveis/decomp_${ver}  > /dev/null 2>&1"
/home/compass/sacompass/previsaopld/shared/install/decomp/${ver}/Executaveis/decomp_${ver}  > /dev/null 2>&1
...
echo "/home/compass/mpich3/bin/mpiexec -f ${hostfile} -n ${cores} /home/compass/sacompass/previsaopld/shared/install/decomp/${ver}/Executaveis/decomp_${ver}";

#rm -f runtrace.dat;

#echo "runtrace apagado";

/home/compass/mpich3/bin/mpiexec -n ${cores} /home/compass/sacompass/previsaopld/shared/install/decomp/${ver}/Executaveis/decomp_${ver}
