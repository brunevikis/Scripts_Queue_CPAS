...
echo "-----------[ Executando Nwlistcf ${ver} ] --------------"
echo /home/producao/PrevisaoPLD/shared/install/newave/newave_${ver}/Executaveis/nwlistcf${ver}
/home/producao/PrevisaoPLD/shared/install/newave/newave_${ver}/Executaveis/nwlistcf${ver};
rc=$?
