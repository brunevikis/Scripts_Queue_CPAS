...
AgendaProximaIteracao(){
    ...
    ord=$(( 20 + 10#0$mesN ))
    usr="encad"
    fn="/home/producao/PrevisaoPLD/enercore_ctl_common/queue/encadeado_earmNWadjust_NW${anoN}${mesN}_${dt}"
    cmd="/home/producao/PrevisaoPLD/enercore_ctl_common/scripts/GNL/encad_dc_nw_mensal_3_30.0.4_earNWadjust_ANA.sh $1"
