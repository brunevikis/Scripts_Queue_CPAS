...
do
    ...
    #echo "${array[2]} ${_vFin}"
    volFinRee[$i]=$( echo 100 $( echo " ${_vFin} * 1 " | bc -l) | awk '{if ($1 < $2) {print $1} else {print $2}}' )
    i=$i+1
...
#Execução DC
    ...
    echo /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/decomp29Viab.sh
    /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/decomp29Viab.sh
