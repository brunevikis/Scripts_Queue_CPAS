...
agendaDCGNL(){
    ...
    cmd="/home/producao/PrevisaoPLD/enercore_ctl_common/scripts/FT/GNL/DADGNL_decomp31.24Viab_earNWmeta_ANA.sh"
...
#  if [[ "$mes" == "01" || "$mes" == "05" || "$mes" == "09" ]]; then
  ...
  if [ ! -f "cortesh.dat" ]; then
      ...
      /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/FT/newave28.16.4_micropen_cortinho_flag3.sh 1
      ec=$?
      if [[ $ec == 1 ]]; then 
          exit 1;
      fi
