...
agendaDCGNL(){
    ...
    usr="encad"
    fn="/home/producao/PrevisaoPLD/enercore_ctl_common/queue/encadeado_DC${ano}${mes}_${dt}"
    cmd="/home/producao/PrevisaoPLD/enercore_ctl_common/scripts/GNL/DADGNL_decomp31.0.2Viab_NW29_earDC_regrasANA.sh"
...
#    fi
    ...
    if [ ! -f "cortes.dat" ]; then
        echo /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/newave29.sh 1
        /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/newave29.sh 1
        ec=$?
        if [[ $ec == 1 ]]; then 
            exit 1;
        fi
