...
agendaDC(){
    ...
    cmd="/home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/decomp29Viab.sh"
...
if [ -d $ano$mes ]; then
    ...
    if [ ! -f "cortes.dat" ]; then
        ...
        echo /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newave260106.sh 1
        /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newave260106.sh 1
    ...
    if [ -f "cortes.dat" ]; then
        ...
        echo /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/nwlistop260106.sh
        /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/nwlistop260106.sh
        ...
        echo /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newdesp260106.sh
        /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newdesp260106.sh
