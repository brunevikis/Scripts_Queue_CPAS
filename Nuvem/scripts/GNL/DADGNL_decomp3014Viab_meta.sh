...
AgendaProximaIteracao(){
    ...
    cmd="/home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/GNL/encad_dc_nw_mensal_3_270412_meta.sh $1"
...
if [[ "$par" == "preliminar" ]]
then
   echo "/home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/FT/decomp.sh $v nao";
   /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/FT/decomp.sh $v nao;
   ec=$?    
else

   echo "/home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/FT/decomp.sh $v";
   /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/FT/decomp.sh $v 8.1.6;
   ec=$? 
fi
#if [ $ec == 0 -o $ec == 7 ]
