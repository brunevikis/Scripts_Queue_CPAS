...
agendaDCGNL(){
    ...
    usr="encad"
    fn="/home/compass/sacompass/previsaopld/cpas_ctl_common/queue/encadeado_DC${ano}${mes}_${dt}"
    cmd="/home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/GNL/DADGNL_decomp301Viab.sh"
...
if [ -d $ano$mes ]; then
    ...
    /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/GNL/Altera_Adterm.sh
