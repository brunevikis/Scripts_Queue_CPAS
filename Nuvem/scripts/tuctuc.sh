...
dadger="dadger.$rv"
[[ $(echo "$(grep "& NO. SEMANAS" "$dadger"|cut -c43)"-1|bc) -eq -1 ]] && exit
[[ "10#$(grep "& MES INICIAL" "dadger.rv0"|cut -c40-42)" -lt 7 ]] && exit
[[ "10#$(grep "& MES INICIAL" "dadger.rv0"|cut -c40-42)" -eq 12 ]] && exit
