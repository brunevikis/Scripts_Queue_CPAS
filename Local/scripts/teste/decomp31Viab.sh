...
par=$1
v="$(echo $0|sed -n 's/\(.*\/decomp\)\([0-9\.]*\)\([[:alpha:]]*\.sh$\)/\2/p')"
gevazp=9
...
then
  ...
  then
    ...
    /usr/bin/dotnet "/home/producao/PrevisaoPLD/shared/price_toolsteste/inviab/bin/Release/netcoreapp3.1/TrataInviab.dll" 1
    /usr/bin/dotnet /home/producao/PrevisaoPLD/shared/price_toolsteste/inviab/bin/Release/netcoreapp3.1/TrataInviab.dll "flexTucurui"
    echo "/home/producao/PrevisaoPLD/enercore_ctl_common/scripts/teste/decomp.sh $v nao";
    /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/teste/decomp.sh "$v" nao;
    ec=$?
    if [ ! -f "sumario.$arq" ]
    then
      ...
      cp -pf ./relato.* ./relato.bkp
      #cp -f relato.bkp "${origin_dir}";
      /usr/bin/dotnet "/home/producao/PrevisaoPLD/shared/price_toolsteste/inviab/bin/Release/netcoreapp3.1/TrataInviab.dll" 3
