...
if [[ "$par" == "preliminar" ]]
then
   echo "/home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/decomp2020.sh $v nao";
   /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/decomp2020.sh $v nao;
   ec=$?    
else
   echo "/home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/decomp2020.sh $v";
   /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/decomp2020.sh $v;
   ec=$? 
fi
#if [ $ec == 0 -o $ec == 7 ]
