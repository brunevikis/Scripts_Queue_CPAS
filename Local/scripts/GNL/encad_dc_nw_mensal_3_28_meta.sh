...
agendaDC(){
    ...
    cmd="/home/producao/PrevisaoPLD/enercore_ctl_common/scripts/decomp31Viab.sh"
...
agendaDCGNL(){
    ...
    usr="encad"
    fn="/home/producao/PrevisaoPLD/enercore_ctl_common/queue/encadeado_DC${ano}${mes}_${dt}"
    cmd="/home/producao/PrevisaoPLD/enercore_ctl_common/scripts/GNL/DADGNL_decomp31Viab_meta.sh"
...
if [ -d $ano$mes ]; then
    ...
    if [ ! -f "cortes.dat" ]; then
        ...
        echo /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/newave28.sh 1
        /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/newave28.sh 1
    ...
    if [ -f "cortes.dat" ]; then
        ...
        echo /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/nwlistop28.sh
        /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/nwlistop28.sh
       ...
       if [[ "$mesN" == "13" ]]; then
        ...
        if [ -d $anoN$mesN ]; then    
          ...
          echo "/usr/share/dotnet/dotnet /home/producao/PrevisaoPLD/shared/price_tools/inviab/bin/Release/netcoreapp3.1/TrataInviab.dll metaencad $ano$mes $anoN$mesN"
          /usr/share/dotnet/dotnet /home/producao/PrevisaoPLD/shared/price_tools/inviab/bin/Release/netcoreapp3.1/TrataInviab.dll "metaencad" "$ano$mes" "$anoN$mesN"
