...
agendaDCGNL(){
    ...
    usr="encad"
    fn="/home/producao/PrevisaoPLD/enercore_ctl_common/queue/encadeado_DC${ano}${mes}_${dt}"
    cmd="/home/producao/PrevisaoPLD/enercore_ctl_common/scripts/FT/GNL/DADGNL_decomp31.17Viab_cortespos.sh"
...
if [ -d $ano$mes ]; then
    ...
    if [ ! -f "cortes.dat" ]; then
        echo /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/FT/newave2812.sh 1
        /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/FT/newave2812.sh 1
        ec=$?
        if [[ $ec == 1 ]]; then 
            exit 1;
        fi
    ...
    if [ -f "cortes.dat" ]; then
      if [ $anomes == "202312" ]; then
        ...
        echo /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/FT/nwlistop2812.sh
        /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/FT/nwlistop2812.sh
      fi
        ec=$?
        if [[ $ec != 0 ]]; then
            exit $ec;
