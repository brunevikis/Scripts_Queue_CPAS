...
then
 ...
 then 
   ...
   dotnet "/home/producao/PrevisaoPLD/shared/Nova pasta/ConsoleApp1/bin/Release/netcoreapp2.0/TrataInviab.dll" 1
   ...
   then    
	 ...
	 dotnet "/home/producao/PrevisaoPLD/shared/Nova pasta/ConsoleApp1/bin/Release/netcoreapp2.0/TrataInviab.dll" 3
