...
agendaDC(){
    ...
    ord=$(( 20 + 10#$mesN ))
    usr="encad"
    fn="/home/compass/sacompass/previsaopld/cpas_ctl_common/queue/encadeado_DC${ano}${mes}_${dt}"
    cmd="/home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/decomp${dcVer}Viab.sh"
...
agendaProximaIteracao(){
    ...
    ord=$(( 20 + 10#$mesN ))
    usr="encad"
    fn="/home/compass/sacompass/previsaopld/cpas_ctl_common/queue/encadeado_NW${anoN}${mesN}_${dt}"
    cmd="$0 $1"
...
if [ -d $ano$mes ]; then
    ...
    if [ ! -f "cortes.dat" ]; then
        ...
        echo /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newave${nwVer}.sh 1
        /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newave${nwVer}.sh 1
    ...
    if [ -f "cortes.dat" ]; then
        ...
        echo /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/nwlistop${nwVer}.sh
        /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/nwlistop${nwVer}.sh
        ...
        echo /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newdesp${nwVer}.sh
        /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newdesp${nwVer}.sh
