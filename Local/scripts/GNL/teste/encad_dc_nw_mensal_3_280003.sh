...
agendaDCGNL(){
    ...
    usr="encad"
    fn="/home/producao/PrevisaoPLD/enercore_ctl_common/queue/encadeado_DC${ano}${mes}_${dt}"
    cmd="/home/producao/PrevisaoPLD/enercore_ctl_common/scripts/GNL/teste/DADGNL_decomp31Viab.sh"
...
if [ -d $ano$mes ]; then
    ...
    echo "/usr/bin/dotnet /home/producao/PrevisaoPLD/shared/price_toolsteste/inviab/bin/Debug/netcoreapp3.1/TrataInviab.dll adterm "
    /usr/bin/dotnet /home/producao/PrevisaoPLD/shared/price_toolsteste/inviab/bin/Debug/netcoreapp3.1/TrataInviab.dll "adterm"
