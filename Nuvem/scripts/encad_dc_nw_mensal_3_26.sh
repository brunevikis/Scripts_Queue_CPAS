...
if [ -d $ano$mes ]; then
    ...
    if [ ! -f "cortes.dat" ]; then
        ...
        echo /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newave26.sh 1
        /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newave26.sh 1
    ...
    if [ -f "cortes.dat" ]; then
        ...
        echo /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/nwlistop26.sh
        /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/nwlistop26.sh
        ...
        echo /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newdesp26.sh
        /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newdesp26.sh
