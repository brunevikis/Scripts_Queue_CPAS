...
agendaDC(){
    ...
    cmd="/home/producao/PrevisaoPLD/cpas_ctl_common/scripts/decomp28.sh"
...
if [ -d $ano$mes ]; then
    ...
    if [ ! -f "cortes.dat" ]; then
        ...
        echo /home/producao/PrevisaoPLD/cpas_ctl_common/scripts/newave240309.sh 1
        /home/producao/PrevisaoPLD/cpas_ctl_common/scripts/newave240309.sh 1
    ...
    if [ -f "cortes.dat" ]; then
        ...
        echo /home/producao/PrevisaoPLD/cpas_ctl_common/scripts/nwlistop240309.sh
        /home/producao/PrevisaoPLD/cpas_ctl_common/scripts/nwlistop240309.sh
        ...
        echo /home/producao/PrevisaoPLD/cpas_ctl_common/scripts/newdesp240309.sh
        /home/producao/PrevisaoPLD/cpas_ctl_common/scripts/newdesp240309.sh
