...
then
	...
	echo "/home/compass/sacompass/previsaopld/shared/auxiliar/nwlistop/nwlistop.dat"
    cp /home/compass/sacompass/previsaopld/shared/auxiliar/nwlistop/nwlistop.dat ./nwlistop.dat
...
echo "-----------[ Executando Nwlistop 27.4.10 ] --------------"
echo "/home/compass/sacompass/previsaopld/shared/install/newave/newave_${ver}/Executaveis/nwlistop${ver}_L"
/home/compass/sacompass/previsaopld/shared/install/newave/newave_${ver}/Executaveis/nwlistop${ver}_L;
rc=$?
