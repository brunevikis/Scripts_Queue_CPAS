#!/bin/bash
LANG=en_US.utf8
comando="/home/producao/PrevisaoPLD/enercore_ctl_common/scripts/decomp32.0.1Viab.sh"
...
then
    ...
    echo /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/buscaEarm_dc_dc2.sh "$(pwd)" "$nrev/$next"
    /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/buscaEarm_dc_dc2.sh "$(pwd)" "$nrev/$next"
