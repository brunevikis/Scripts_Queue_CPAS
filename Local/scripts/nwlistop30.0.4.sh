...
echo "/home/producao/PrevisaoPLD/shared/install/newave/newave_${ver}/Executaveis/nwlistop${ver}"
/home/producao/PrevisaoPLD/shared/install/newave/newave_${ver}/Executaveis/nwlistop${ver};
rc=$?
