...
agendaDCGNL(){
    ...
    usr="encad"
    fn="/home/compass/queuectl/queue/encadeado_DC${ano}${mes}_${dt}"
    cmd="/home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/GNL/DADGNL_decomp3011Viab.sh"
...
if [ -d $ano$mes ]; then
    ...
    if [ ! -f "cortes.dat" ]; then
        ...
        echo /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newave270405.sh 1
        /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newave270405.sh 1
    ...
    if [ -f "cortes.dat" ]; then
        ...
        echo /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/nwlistop270405.sh
        /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/nwlistop270405.sh
        ...
        echo /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newdesp270405.sh
        /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/newdesp270405.sh
