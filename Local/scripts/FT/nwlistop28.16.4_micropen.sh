...
echo "-----------[ Executando Nwlistop 28.16.4 micropen ] --------------"
echo "/home/producao/PrevisaoPLD/shared/install/newave/newave_${ver}_L/Executaveis/nwlistop${ver}_L"
/home/producao/PrevisaoPLD/shared/install/newave/newave_${ver}_L/Executaveis/nwlistop${ver}_L;
rc=$?
