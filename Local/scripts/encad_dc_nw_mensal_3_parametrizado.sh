...
agendaDC(){
    ...
    cmd="/home/producao/PrevisaoPLD/cpas_ctl_common/scripts/decomp${dcVer}Viab.sh"
...
if [ -d $ano$mes ]; then
    ...
    if [ ! -f "cortes.dat" ]; then
        ...
        echo /home/producao/PrevisaoPLD/cpas_ctl_common/scripts/newave${nwVer}.sh 1
        /home/producao/PrevisaoPLD/cpas_ctl_common/scripts/newave${nwVer}.sh 1
    ...
    if [ -f "cortes.dat" ]; then
        ...
        echo /home/producao/PrevisaoPLD/cpas_ctl_common/scripts/nwlistop${nwVer}.sh
        /home/producao/PrevisaoPLD/cpas_ctl_common/scripts/nwlistop${nwVer}.sh
        ...
        echo /home/producao/PrevisaoPLD/cpas_ctl_common/scripts/newdesp${nwVer}.sh
        /home/producao/PrevisaoPLD/cpas_ctl_common/scripts/newdesp${nwVer}.sh
