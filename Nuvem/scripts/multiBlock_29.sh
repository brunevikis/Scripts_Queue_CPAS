...
then
    ...
    /home/compass/sacompass/previsaopld/cpas_ctl_common/scripts/decomp29.sh preliminar;
    ec=$?
    ...
    then
        ...
        usr="multiblock"
        dir=$( pwd )         
        fn="/home/compass/sacompass/previsaopld/cpas_ctl_common/queue/multblock_${i}_${dt}"
