...
agendaDC(){
    ...
    cmd="/home/producao/PrevisaoPLD/enercore_ctl_common/scripts/teste/decomp31Viab.sh"
...
AgendaProximaIteracao(){
    ...
    cmd="/home/producao/PrevisaoPLD/enercore_ctl_common/scripts/GNL/teste/encad_dc_nw_mensal_3_280003.sh $1"
...
echo "/usr/bin/dotnet /home/producao/PrevisaoPLD/shared/price_toolsteste/inviab/bin/Debug/netcoreapp3.1/TrataInviab.dll dadgnl";

/usr/bin/dotnet /home/producao/PrevisaoPLD/shared/price_toolsteste/inviab/bin/Debug/netcoreapp3.1/TrataInviab.dll "dadgnl"
            ...
            if [ -d "$dc/$ano$mes" ]; then
				...
				then
                    ...
                    then
                        ...
                        /usr/bin/dotnet /home/producao/PrevisaoPLD/shared/price_toolsteste/inviab/bin/Debug/netcoreapp3.1/TrataInviab.dll "RV0"
...
if [[ "$par" == "preliminar" ]]
then
   echo "/home/producao/PrevisaoPLD/enercore_ctl_common/scripts/teste/decomp.sh $v nao";
   /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/teste/decomp.sh "$v" nao;
   ec=$?
else
   echo "/home/producao/PrevisaoPLD/enercore_ctl_common/scripts/teste/decomp.sh $v";
   /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/teste/decomp.sh "$v" "$gevazp";
   ec=$?
fi
...
then
  ...
  then
    ...
    /usr/bin/dotnet "/home/producao/PrevisaoPLD/shared/price_toolsteste/inviab/bin/Debug/netcoreapp3.1/TrataInviab.dll" 1
    /usr/bin/dotnet /home/producao/PrevisaoPLD/shared/price_toolsteste/inviab/bin/Debug/netcoreapp3.1/TrataInviab.dll "flexTucurui"
    echo "/home/producao/PrevisaoPLD/enercore_ctl_common/scripts/teste/decomp.sh $v nao";
    /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/testes/decomp.sh "$v" nao;
    ec=$?
    if [ ! -f "sumario.$arq" ]
    then
      ...
      cp -pf ./relato.* ./relato.bkp
      #cp -f relato.bkp "${origin_dir}";
      /usr/bin/dotnet "/home/producao/PrevisaoPLD/shared/price_toolsteste/inviab/bin/Debug/netcoreapp3.1/TrataInviab.dll" 3
      /usr/bin/dotnet /home/producao/PrevisaoPLD/shared/price_toolsteste/inviab/bin/Debug/netcoreapp3.1/TrataInviab.dll "flexTucurui"
      echo "/home/producao/PrevisaoPLD/enercore_ctl_common/scripts/teste/decomp.sh $v nao";
      /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/teste/decomp.sh "$v" nao;
      ec=$?
