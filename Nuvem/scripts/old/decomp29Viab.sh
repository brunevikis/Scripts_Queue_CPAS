...
cortesPath=$( grep cortes.dat dadger.$arqName | cut -c15-120 )
corteshPath=$( grep cortesh.dat dadger.$arqName | cut -c15-120 )
...
sed '/^FC/d' dadger.$arqName | sed 's/^\&FC/FC/' > dadger.$arqName.lower;
rm dadger.$arqName;
mv dadger.$arqName.lower dadger.$arqName;
