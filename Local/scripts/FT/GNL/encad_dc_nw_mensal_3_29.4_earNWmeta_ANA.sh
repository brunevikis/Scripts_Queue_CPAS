...
agendaDCGNL(){
    ...
    cmd="/home/producao/PrevisaoPLD/enercore_ctl_common/scripts/FT/GNL/DADGNL_decomp31.27Viab_earNWmeta_ANA.sh"
...
#  if [[ "$mes" == "01" || "$mes" == "05" || "$mes" == "09" ]]; then
  ...
  if [ ! -f "cortesh.dat" ]; then
      echo /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/FT/newave29.4.sh 1
      /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/FT/newave29.4.sh 1
      ec=$?
      if [[ $ec == 1 ]]; then 
          exit 1;
      fi
...
-----------------------------------------------------------------------------------------------------------------------
 ...
 999
EOF
    echo /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/FT/nwlistop29.4.sh
    /home/producao/PrevisaoPLD/enercore_ctl_common/scripts/FT/nwlistop29.4.sh
